clear all;
clc;
% This is a test of buildings and random 30 using interior point method
% Constraint tolerance is 1e-3
% construction of utur
image = imread('../../test_images/256_256_buildings.png');%picture RGB
...
% **************************************************
% construction of A
mask = imread('../../test_masks/256_256_random30.png');
Ind = mask;
