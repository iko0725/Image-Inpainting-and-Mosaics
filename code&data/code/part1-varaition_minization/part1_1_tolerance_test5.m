clear all;
clc;
% This is a test of circles and random 70 using interior point method
% And change Constraint tolerance to 1e-3,1e-2,1e-1;
...
options_2.ConstraintTolerance = 1e-2;
...
%1e-6
options_3 = optimoptions('linprog','Algorithm','interior-point');
options_3.ConstraintTolerance = 1e-1;
